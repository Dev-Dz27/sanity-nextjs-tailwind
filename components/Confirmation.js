...
const Confirmation = () => {
  ...
  <div class="container px-4 mx-auto">
    <div class="max-w-2xl mx-auto text-center">
      ...
      <p class="text-lg font-bold mb-12">Build a well-presented brand that everyone will love. Take care to develop resources continually and integrity them with previous projects.</p>
